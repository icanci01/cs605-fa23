...
// MY CODE
// branch structure to hold stats
typedef struct{
...
// map to hold <ip, branch_stats*> pair
// unordered_map<uint64_t, branch_stats*> branches_map;
extern map<uint64_t, branch_stats*> branches_map[NUM_CPUS];
// END OF CODE
